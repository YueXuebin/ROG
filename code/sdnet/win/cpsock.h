...
public:
	...
	*/
	...
	{
		InterlockedIncrement((volatile long*)&m_dwPostSend);
	}
	...
	*/
	...
	{
		InterlockedDecrement((volatile long*)&m_dwPostSend);
	}
	...
	* @return 目前还有的发送消息计数
	*/
    size_t GetPostSend(void)
	{
		return InterlockedExchange((volatile long*)&m_dwPostSend, m_dwPostSend);
	}
	...
	*/
	...
	{
		InterlockedIncrement((volatile long*)&m_dwPostRecv);
	}
	...
	*/
	...
	{
		InterlockedDecrement((volatile long*)&m_dwPostRecv);
	}
	...
	* @return 目前还有的接收消息计数
	*/
	size_t GetPostRecv(void)
	{
		return InterlockedExchange((volatile long*)&m_dwPostRecv, m_dwPostRecv);
	}
...
protected:
	...
	*/
	...
	void _OnError(int32 nSDError, int32 nSysError);
