...
b2Fixture* b2Body::CreateFixture(const b2FixtureDef* def)
{
	...
	// 计算物品的质量, Adjust mass properties if needed.
	if (fixture->m_density > 0.0f)
	{
		ResetMassData();
	}

	// 给body添加fixtrue时,标记flags,使之创建新的连接对象. 
...
void b2Body::ResetMassData()
{
	...
	// 静态物品没有质量, Static and kinematic bodies have zero mass.
	...
	// 计算所有fixture的总质量, Accumulate mass over all fixtures.
...
{
	// 动态物体才会碰撞, At least one body should be dynamic.
