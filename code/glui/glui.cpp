...
void   GLUI_Master_Object::close_all( void ) 
{
  ...
  // 删除内部创建的glui_glut_window
  GLUI_Glut_Window* glutWin = (GLUI_Glut_Window*)GLUI_Master.glut_windows.first_child();
  while(glutWin) {
    GLUI_Glut_Window* delWin = glutWin;
    glutWin = (GLUI_Glut_Window*)glutWin->next();
    delete delWin;
  }
