...
RegularMaoXian_019::RegularMaoXian_019(RegularDoc* pDoc) :
RegularMaoXianBase(pDoc)
{

}

RegularMaoXian_019::~RegularMaoXian_019()
{

}

void RegularMaoXian_019::FirstUpdate()
{
	...
	pPointMonster->SetRadius(0);
	pPointMonster->SetMonster(3319, 1);
	pPointMonster->SetQuality(QUALITY_GREEN);
