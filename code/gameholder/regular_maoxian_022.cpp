...
// 关卡类的构造函数
RegularMaoXian_022::RegularMaoXian_022(RegularDoc* pDoc) :
RegularMaoXianBase(pDoc)
{

}
// 关卡类的析构函数
RegularMaoXian_022::~RegularMaoXian_022()
{

}
// 关卡开始时的,关卡内容配置
void RegularMaoXian_022::FirstUpdate()
{
    ...
    pPointMonster->SetRadius(0);
    pPointMonster->SetMonster(3322, 1);
