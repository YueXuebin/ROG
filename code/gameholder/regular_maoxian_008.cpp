...
// 关卡类的构造函数
RegularMaoXian_008::RegularMaoXian_008(RegularDoc* pDoc) :
RegularMaoXianBase(pDoc)
{

}
// 关卡类的析构函数
RegularMaoXian_008::~RegularMaoXian_008()
{

}
// 关卡开始时的,关卡内容配置
void RegularMaoXian_008::FirstUpdate()
{
	...
	pEventMonsterDead->SetMonster(3308, 1);
	...
	pPointMonster->SetMonster(3004,1);                // 怪物类型 数量
	...
	pPointMonster->SetRadius(100);                    // 区域
	pPointMonster->SetDelayTime(50);                // 延时出怪
	pPointMonster->SetMonster(3003,1);                // 怪物类型 数量
	pPointMonster->SetSpawnSpeed(300);                // 出怪间隔300ms
...
////////////////////////////////////////////////////////////////////////////////////////////02
	...
	pPointMonster->SetMonster(3001,2);                // 怪物类型 数量
...
///////////////////////////////////////////////////////////////////////////////////////////06
	...
	pPointMonster->SetMonster(3039,1);                // 怪物类型 数量
	pPointMonster->SetDefaultMovie();                 // 出场演绎
	pPointMonster->SetSpawnSpeed(500);                // 出怪间隔300ms
	pPointMonster->SetTriggerID(11);                  // Trigger点事件触发
...
//////////////////////////////////////////////////////////////////////////////////////////09
	...
	pPointMonster13->SetMonster(3308,1);                // 怪物类型 数量
	...
	pPointMonster13->SetQuality (QUALITY_GREEN);
