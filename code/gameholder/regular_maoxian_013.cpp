...
// 关卡类的构造函数
RegularMaoXian_013::RegularMaoXian_013(RegularDoc* pDoc) :
RegularMaoXianBase(pDoc)
{

}
// 关卡类的析构函数
RegularMaoXian_013::~RegularMaoXian_013()
{

}
// 关卡开始时的,关卡内容配置
void RegularMaoXian_013::FirstUpdate()
{
    ...
    pPointMonster->SetMonster(3070, 1);
	...
	pPointMonster->SetRadius(100);
	pPointMonster->SetMonster(3313, 1);
