...
// 关卡类的构造函数
RegularMaoXian_010::RegularMaoXian_010(RegularDoc* pDoc) :
RegularMaoXianBase(pDoc)
{

}
// 关卡类的析构函数
RegularMaoXian_010::~RegularMaoXian_010()
{

}
// 关卡开始时的,关卡内容配置
void RegularMaoXian_010::FirstUpdate()
{
    ...
    pEventMonsterDead->SetMonster(3310, 1);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	pPointMonster->SetRadius(100);
	pPointMonster->SetMonster(3310, 1);         // 出什么怪(怪id, 数量)
	//pPointMonster->SetDefaultMovie();           // 出场演绎
