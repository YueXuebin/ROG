...
// 关卡类的构造函数
RegularMaoXian_009::RegularMaoXian_009(RegularDoc* pDoc) :
RegularMaoXianBase(pDoc)
{

}
// 关卡类的析构函数
RegularMaoXian_009::~RegularMaoXian_009()
{

}
// 关卡开始时的,关卡内容配置
void RegularMaoXian_009::FirstUpdate()
{
	...
	pPointMonster = CnNew PointMonster(this, 24);
	pPointMonster->SetRadius(300);
	pPointMonster->SetMonster(3309, 1);
