...
RegularMaoXian_021::RegularMaoXian_021(RegularDoc* pDoc) :
RegularMaoXianBase(pDoc)
{

}

RegularMaoXian_021::~RegularMaoXian_021()
{

}

void RegularMaoXian_021::FirstUpdate()
{
    ...
    pEventMonsterDead->SetMonster(3321, 1);
...
///////////////////////////////////////////////////////////////////////////////// 08
	...
	pPointMonster->SetRadius(100);                    // 区域
	pPointMonster->SetDelayTime(100);                  // 延时出怪
	pPointMonster->SetMonster(3321,1);                // 怪物类型 数量
