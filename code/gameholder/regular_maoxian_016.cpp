...
RegularMaoXian_016::RegularMaoXian_016(RegularDoc* pDoc) :
RegularMaoXianBase(pDoc)
{

}

RegularMaoXian_016::~RegularMaoXian_016()
{

}

void RegularMaoXian_016::FirstUpdate()
{
    ...
    pEventMonsterDead->SetMonster(3316, 1);
    ...
    pPointMonster->SetRadius(200);
    pPointMonster->SetMonster(3316, 1);         // 出什么怪(怪id, 数量)
