...
RegularMaoXian_015::RegularMaoXian_015(RegularDoc* pDoc) :
RegularMaoXianBase(pDoc)
{

}

RegularMaoXian_015::~RegularMaoXian_015()
{

}

void RegularMaoXian_015::FirstUpdate()
{
    ...
    pEventMonsterDead->SetMonster(3315, 1);
	...
	pPointMonster->SetRadius(100);
	pPointMonster->SetMonster(3315, 1);         // 出什么怪(怪id, 数量)
	//pPointMonster->SetDefaultMovie();           // 出场演绎
