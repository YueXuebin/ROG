...
RegularMaoXian_101::RegularMaoXian_101(RegularDoc* pDoc) :
RegularMaoXianBase(pDoc)
{

}

RegularMaoXian_101::~RegularMaoXian_101()
{

}

void RegularMaoXian_101::FirstUpdate()
{
	...
	// 胜利条件
	ROGRegularEvent_MonsterDead* pEventSucceed_MonsterDead = CnNew ROGRegularEvent_MonsterDead(this);
	pEventSucceed_MonsterDead->SetMonster(3049, 1);
	AddSucceedEvent(pEventSucceed_MonsterDead); // 杀死怪

	// 失败条件
	ROGRegularEvent_PlayerDead* pEventFailed_PlayerDead = CnNew ROGRegularEvent_PlayerDead(this);
	AddFailedEvent(pEventFailed_PlayerDead); // 玩家死亡
