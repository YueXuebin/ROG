...
RegularMaoXian_201::RegularMaoXian_201(RegularDoc* pDoc) :
RegularMaoXianBase(pDoc)
{

}

RegularMaoXian_201::~RegularMaoXian_201()
{

}

void RegularMaoXian_201::FirstUpdate()
{
    ...
    pEventFailed_Timer->SetTime(1000*180);            // n秒限时
    AddFailedEvent(pEventFailed_Timer);

    // 评价条件
    ROGRegularEvent_ThreePlayer* pEventScore_ThreePlayer = CnNew ROGRegularEvent_ThreePlayer(this);
    AddScoreEvent(pEventScore_ThreePlayer);             // 三人通关无人退出

    ROGRegularEvent_DamageRank* pEventScore_DamageRank = CnNew ROGRegularEvent_DamageRank(this);
    AddScoreEvent(pEventScore_DamageRank);              // 伤害排名第一
