...
RegularMaoXian_023::RegularMaoXian_023(RegularDoc* pDoc) :
RegularMaoXianBase(pDoc)
{

}

RegularMaoXian_023::~RegularMaoXian_023()
{

}

void RegularMaoXian_023::FirstUpdate()
{
    ...
    pEventMonsterDead->SetMonster(3323, 1);
	...
	pPointMonster->SetRadius(100);
	pPointMonster->SetMonster(3323, 1);         // 出什么怪(怪id, 数量)
	//pPointMonster->SetDefaultMovie();           // 出场演绎
