...
// 关卡类的构造函数
RegularMaoXian_170::RegularMaoXian_170(RegularDoc* pDoc) :
RegularMaoXianBase(pDoc)
{

}
// 关卡类的析构函数
RegularMaoXian_170::~RegularMaoXian_170()
{

}
// 关卡开始时的,关卡内容配置
void RegularMaoXian_170::FirstUpdate()
{
