...
// 关卡类的构造函数
RegularMaoXian_018::RegularMaoXian_018(RegularDoc* pDoc) :
RegularMaoXianBase(pDoc)
{

}
// 关卡类的析构函数
RegularMaoXian_018::~RegularMaoXian_018()
{

}
// 关卡开始时的,关卡内容配置
void RegularMaoXian_018::FirstUpdate()
{
    ...
    pPointMonster->SetRadius(0);
    pPointMonster->SetMonster(3318, 1);
    //pPointMonster->SetMax(1);                   // 一次1个，共4个
    pPointMonster->SetDefaultMovie();
    pPointMonster->SetDelayTime(300);
    pPointMonster->SetSpawnSpeed(200);
