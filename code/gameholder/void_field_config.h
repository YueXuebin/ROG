...
//    }
//
//    int32 norlmal;        //普通模式概率
//    int32 boss;           //boss模式概率
//    int32 moonless;       //月黑模式概率
//    int32 count;        //总概率 /普通+boos+月黑  
//    int32 time ;        //累计时间
//}ChestsProbability;
...
private:
    ...
    int32   m_moonless_rob_rate;                    ///< 月黑状态虚空宝箱抢夺率
    uint32  m_rare_boss_id;                         ///< 珍兽BOSS id
    uint32  m_outscope_notify_interval;             ///< 玩家离开珍兽范围通知间隔时间
    uint32  m_channel_max_player;                   ///< 频道最大人数限制
    uint32  m_moonless_reward_box_num;              ///< 月黑奖励宝箱数量
    uint32  m_moonless_reward_box_interval;         ///< 月黑奖励宝箱间隔
    ...
    //typedef std::map<uint32, int32> ChestsProbabilityMap;///<.掉落宝箱的概率
