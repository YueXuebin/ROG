...
#define S44 21
    ...
    static void MD5Transform(uint32 [4], byte [64]);
    static void Encode(byte *, uint32 *, unsigned int);
    static void Decode(uint32 *, byte *, unsigned int);
...
#define II(a, b, c, d, x, s, ac) { \
    ...
    */
    void SDMD5Final (byte digest[16], /* message digest */
    ...
    */
    ...
    a multiple of 4.
    */
    static void Encode (byte *output,uint32 *input,unsigned int len)
    {
        unsigned int i, j;
    ...
    a multiple of 4.
    */
    static void Decode(uint32 *output, byte *input, unsigned int len)
    {
        unsigned int i, j;
    ...
    */
    ...
    static void MD5_memcpy(byte* output, byte* input, unsigned int len)
    {
        unsigned int i;
    ...
    */
    static void MD5_memset(byte* output, int value, unsigned int len)
    {
        unsigned int i;
	...
	bool SDAPI SDFileMD5(byte acDigest[16], const char* pszFileName, bool bFileMapping)
	{
        ...
        if (bFileMapping)
        {
			...
			while(lastPos < fileMap.size)
			{
				...
				{
					SDMD5Update(&mCtx, ((byte*)fileMap.mem) + lastPos, fileMap.size - lastPos);
					lastPos = fileMap.size;
				}
				else
				{
					SDMD5Update(&mCtx, ((byte*)fileMap.mem) + lastPos, ChunkSize);
					lastPos += ChunkSize;
				}
			}
